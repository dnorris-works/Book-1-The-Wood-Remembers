...
2. **Set up MailerLite first**
   ...
   - Automation: 5 to 6 email welcome sequence
   - Tag/click tracking for people who click the Amazon link
3. **Set up StoryOrigin Standard**
   - Upload the reader magnet.
   - Connect MailerLite.
...
5. **After 30 days**
   - Check signups, opens, clicks, unsubscribes, and Amazon link clicks.
   - Improve the magnet title, cover, landing copy, or promo category based on data.

I’d avoid paying for BookFunnel right now unless StoryOrigin’s delivery frustrates you. You can add BookFunnel later without changing the core because MailerLite remains the source of truth.